  ...
  return <div className="min-h-screen flex flex-col">
      ...
      <section className="py-16 px-4 bg-gradient-to-br from-brand-green/5 to-brand-darkgreen/5">
        <div className="container mx-auto max-w-5xl text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-brand-green to-brand-darkgreen bg-clip-text text-transparent">
            Vote for your favorites, worldwide
          </h1>
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Rankinge lets you vote on the best products, brands, and more across thousands of categories. Discover what's popular and add your voice.
          </p>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-2xl font-bold text-gray-900 mb-12 text-center">How Rankinge Works</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card>
              <CardContent className="pt-6 text-center">
                <div className="bg-brand-green/10 rounded-full w-12 h-12 mx-auto mb-4 flex items-center justify-center">
      ...
      {/* CTA Section */}
      <section className="py-16 px-4 bg-gradient-to-r from-brand-green to-brand-darkgreen text-white">
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-2 mb-4 md:mb-0">
              ...
              <span className="text-lg font-bold text-white">Rankinge</span>
            </div>
